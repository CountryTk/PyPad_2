...
highlighter::highlighter(QTextDocument *editor_file, QString extension)
    ...
    HighlightingRule rule;
       ...
       QString function_pattern;#include "highlighter.h"
#include <QRegularExpression>
#include <QDebug>
#include <iostream>
#include <QDebug>
...
highlighter::highlighter(QTextDocument *editor_file, QString extension)
    ...
    HighlightingRule rule;
       ...
       if (magic_format != "") { // if this evaluates to true we are dealing with a python file.
       ...
       quotationFormat.setForeground(quotation_color);
